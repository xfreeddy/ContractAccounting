...
CI/CD
При каждом push и pull request автоматически запускается GitHub Actions:
устанавливаются зависимости, выполняется линтер flake8, прогоняются модульные
тесты pytest и собирается исполняемый файл ContractAccounting.exe
