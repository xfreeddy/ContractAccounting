...
class MainWindow(QMainWindow):
    ...
    def create_add_form(self) -> QFrame:
        ...
        form_title = QLabel("Добавить новый договор")
        ...
        # Кнопка сохранения
        save_btn = QPushButton("💾 Сохранить договор в систему")
        ...
        """)
        save_btn.clicked.connect(self._save_contract)
        form_layout.addWidget(save_btn, alignment=Qt.AlignLeft)
    ...
    def _edit_contract(self, row: int):
        ...
        QMessageBox.information(
            self,
            "Редактирование",
            "Данные загружены в форму. Измените и нажмите Сохранить.",
        )
